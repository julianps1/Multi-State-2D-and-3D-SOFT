...
void run_nafh_driver(const std::string &surface_dir)
{
	...
	const std::filesystem::path executable = work_dir / "nafh_surf";
	...
	const int status = std::system("./nafh_surf");
	...
	{
		const std::string surface_dir = "/home/msafo/Multi_State_2D_AND_3D_SOFT/Multi-State-2D-and-3D-SOFT/nafh_2d_surfaces";
